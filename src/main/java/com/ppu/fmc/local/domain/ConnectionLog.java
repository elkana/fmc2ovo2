...
public class ConnectionLog {
	...
	public String toString() {
		return "ConnectionLog [id=" + id + ", macaddr=" + macaddr + ", ipaddrhex=" + ipaddrhex + ", ipaddr=" + ipaddr
				...
				+ ", sentdate=" + sentdate + ", getId()=" + getId() + ", getMacaddr()=" + getMacaddr()
				+ ", getIpaddrhex()=" + getIpaddrhex() + ", getIpaddr()=" + getIpaddr() + ", getUrl()=" + getUrl()
				+ ", getIplocation()=" + getIplocation() + ", getFirstpacketsec()=" + getFirstpacketsec()
				+ ", getLastpacketsec()=" + getLastpacketsec() + ", getFpsdate()=" + getFpsdate()
				+ ", getCreateddate()=" + getCreateddate() + ", getSentdate()=" + getSentdate() + ", getClass()="
